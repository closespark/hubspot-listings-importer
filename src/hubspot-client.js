...
class HubSpotClient {
  ...
  async createListingsObject() {
    const schema = {
      ...
      secondaryDisplayProperties: ['hs_address_1', 'hs_city', 'hs_state', 'reference_id'],
      searchableProperties: ['external_listing_id', 'reference_id', 'hs_address_1', 'hs_city', 'hs_state', 'state_code', 'hs_zip'],
